...
import re
import sys
sys.path.append(r'C:\Users\prati\Documents\Projects\QClisting\AmazonSearchProductSpider')
...
class AmazonSearchProductSpider(scrapy.Spider):
    ...
    def start_requests(self):
        keyword_list = [pd.read_csv(r'C:\Users\prati\Documents\Projects\QClisting\AmazonSearchProductSpider\DataStore\keyword_list.csv')['keyword_list'][0]]
